  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-accent text-accent-foreground hover:bg-accent/90 shadow-card hover:shadow-glow hover:-translate-y-1 font-semibold",
        safari: "bg-safari-gradient text-white hover:scale-105 shadow-card hover:shadow-glow font-semibold",
        ocean: "bg-ocean-gradient text-white hover:scale-105 shadow-card hover:shadow-glow font-semibold",
        whatsapp: "bg-green-500 text-white hover:bg-green-600 hover:shadow-glow hover:-translate-y-1 font-semibold",
      },
      size: {
